...
export default function CancellationFeesTeacherCard({ event, onClose, onDateChange }) {
    ...
    return (
        <div className="bg-white rounded-lg shadow-md p-4 w-full max-w-sm mx-auto" onClick={(e) => e.stopPropagation()}>
            <div className="flex items-center justify-center gap-2 mb-2">
                ...
                <h3 className="text-center font-bold text-lg m-0">Cancellation Fees (T)</h3>
            </div>
                ...
                <Popover>
                    ...
                    <PopoverContent className="w-56">
                        <ul className="space-y-1">
                            ...
                            <li><Button variant="ghost" className="w-full justify-start text-red-600 hover:text-red-700">Refund</Button></li>
                        </ul>
                    </PopoverContent>
                </Popover>
            </div>
