...
export default function BookedAsTeacherRescheduleCard({ event, onClose, onDateChange }) {
                ...
                <Popover>
                    ...
                    <PopoverContent className="w-56">
                        <ul className="space-y-1">
                            <li><Button variant="ghost" className="w-full justify-start">Reschedule</Button></li>
