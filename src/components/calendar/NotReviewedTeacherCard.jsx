...
export default function NotReviewedTeacherCard({ event, onClose }) {
    ...
    return (
        <div className="bg-white rounded-lg shadow-md p-4 w-full max-w-sm mx-auto" onClick={(e) => e.stopPropagation()}>
            <h3 className="text-center font-bold text-lg mb-2">Not Reviewed (T)</h3>
                ...
                <Popover>
                    ...
                    <PopoverContent className="w-56">
                        <ul className="space-y-1">
                            ...
                            <li><Button variant="ghost" className="w-full justify-start">Raise A Dispute (T)</Button></li>
            ...
            <div className="flex gap-3">
                ...
                <Button className="bg-green-500 hover:bg-green-600 text-white">Remind To Review</Button>
            </div>
        </div>
    );
}
