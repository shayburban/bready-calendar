...
import { MoreVertical, Pencil, Trash2, Mail, Bell, CreditCard, ChevronDown, Plus, RefreshCw, X, Copy } from 'lucide-react';
...
export default function BookedAsStudentCard({ event, onClose, onDateChange }) {
    ...
    return (
        <div className="bg-white rounded-lg shadow-md p-4 w-full max-w-sm mx-auto" onClick={(e) => e.stopPropagation()}>
            <h3 className="text-center font-bold text-lg mb-1">Booked (S)</h3>
                ...
                <Popover>
                    ...
                    <PopoverContent className="w-56">
                        <ul className="space-y-1">
                            <li><Button variant="ghost" className="w-full justify-start"><Copy className="w-4 h-4 mr-2" />Duplicate meeting</Button></li>
                            <li><Button variant="ghost" className="w-full justify-start">View As A Teacher (T)</Button></li>
                            <li><Button variant="ghost" className="w-full justify-start">Reschedule As A Student (S)</Button></li>
                            <li><Button variant="ghost" className="w-full justify-start">Check Teacher Availability</Button></li>
                            <li><Button variant="ghost" className="w-full justify-start">Cancel Booking (S)</Button></li>
                        </ul>
                    </PopoverContent>
                </Popover>
            </div>
