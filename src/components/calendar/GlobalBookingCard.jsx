...
import { Calendar as CalendarIcon, MoreVertical, Pencil, Trash2, Mail, Bell, CreditCard, ChevronDown, Plus, RefreshCw, X, Copy } from 'lucide-react';
import { Calendar } from '@/components/ui/calendar';
import TabSelector from '../common/TabSelector'; // Added import for TabSelector
...
export default function GlobalBookingCard({ event, onClose }) {
    const [notifications, setNotifications] = useState([1]);
    const [emailNotifications, setEmailNotifications] = useState([1]);
    const [date, setDate] = useState(new Date(2021, 6, 19));
    const [activeTimeSlot, setActiveTimeSlot] = useState('15:00 - 16:00'); // Added state for active time slot
    ...
    return (
        <div className="bg-white rounded-lg shadow-md p-4 w-full max-w-sm mx-auto" onClick={(e) => e.stopPropagation()}>
            <h3 className="text-center font-bold text-lg mb-1">Booked (T)</h3>
            ...
            <div className="flex justify-center items-center gap-2 mb-3">
                {/* Replaced time slot buttons with TabSelector */}
                <TabSelector
                    tabs={timeSlots}
                ...
                <Popover>
                    ...
                    <PopoverContent className="w-56">
                        <ul className="space-y-1">
                            <li><Button variant="ghost" className="w-full justify-start"><Copy className="w-4 h-4 mr-2" />Duplicate</Button></li>
                            <li><Button variant="ghost" className="w-full justify-start">View As A Student (S)</Button></li>
                            <li><Button variant="ghost" className="w-full justify-start">Reschedule As A Teacher (T)</Button></li>
                            <li><Button variant="ghost" className="w-full justify-start">Check Student Availability</Button></li>
                            <li><Button variant="ghost" className="w-full justify-start">Cancel Booking (T)</Button></li>
                        </ul>
                    </PopoverContent>
                </Popover>
            </div>
            ...
            <div className="text-sm space-y-1 mb-4">
                <p className="text-gray-900 font-bold underline">Student N.</p>
            ...
            <div className="text-xs space-y-1 mb-4 opacity-75">
                ...
                <p><span className="font-bold">Old Rate:</span> 5 $ for 1 Hr. till 03.08.2021</p>
            ...
            <details className="text-sm" open>
                ...
                <div className="pt-2 pl-4 space-y-4">
                    ...
                    <div>
                        ...
                        <div className="space-y-2 pl-2">
                            {emailNotifications.map((id, index) =>
