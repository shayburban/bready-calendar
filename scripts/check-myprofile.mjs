...
const ROUTES = [
  '/MyProfile?role=teacher&uid=u-sarah',
  '/MyProfile?role=teacher&uid=u-ahmed',
  '/MyProfile?role=student&uid=u-student1',
];
...
for (const r of ROUTES) {
  ...
  await page.screenshot({
    path: `role-screens/myprofile-${r.split('?')[1].replace(/[^a-z0-9]/gi, '_')}.png`,
    fullPage: true,
  });
